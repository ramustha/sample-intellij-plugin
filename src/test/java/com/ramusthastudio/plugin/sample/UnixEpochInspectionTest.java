...
public class UnixEpochInspectionTest extends LightJavaCodeInsightFixtureTestCase {
  ...
  protected void doTest(@NotNull String testName, int expectedHighlighting) {
    ...
    myFixture.enableInspections(new UnixEpochInspection());

    List<HighlightInfo> highlightInfos = myFixture.doHighlighting()
        .stream()
        .filter(h -> "UnixEpochInspection".equals(h.getInspectionToolId()))
