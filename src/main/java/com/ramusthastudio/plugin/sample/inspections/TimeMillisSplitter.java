package com.ramusthastudio.plugin.sample.inspections;
...
public class TimeMillisSplitter extends BaseSplitter {
  private static final TimeMillisSplitter INSTANCE = new TimeMillisSplitter();

  public static TimeMillisSplitter getInstance() {
    return INSTANCE;
  }
